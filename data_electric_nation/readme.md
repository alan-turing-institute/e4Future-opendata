...
The notebook assumes that the raw data files for each provider (can be found on Sharepoint or on the WPD Electric Nation webpage mentioned above) are located in the folder `raw_data`. Note that this directory was added to `.gitignore`. 
